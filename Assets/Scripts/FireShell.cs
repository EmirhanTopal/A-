...
public class FireShell : MonoBehaviour {
    ...
    float? CalculateAngel(bool low)
    {
        ...
        float y = targetDir.y;
        // Hedefin y eksenini sıfırla
        targetDir.y = 0f;
        
        // Hedefin x eksenindeki uzunluğunu hesapla
        float x = targetDir.magnitude - 1;
        
        // Yerçekimi kuvvetini al
        float gravity = 9.8f;
        
        // En yüksek ve en düşük açıları hesapla
        ...
        if (underTheSqrRoot >= 0f)
        {
            ...
            float highAngle = sSqr + root; // formülde yüksek açı istiyorsak +- kısmından + yı al ve v^2 ile topla.
            float lowAngle = sSqr - root; // formülde düşük açı istiyorsak +- kısmından - yı al ve v^2 ile çıkart.
            
            // istenilen açıyı döndür.
            if (low)
